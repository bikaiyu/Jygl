...
public class SDCardHelper {
	...
	public static Bitmap loadBitmapFromSDCar(String filePath,Context context){
		Log.i("读取SD卡的目录",context.getExternalCacheDir()+"/"+filePath);
		byte[] data = loadFileFromSDCard(context.getExternalCacheDir()+"/"+filePath);
		if(data == null)
			return null;
	...
	// 获取SDCard私有的Files目录
	public static String getSDCardPrivateFilePath(Context context, String type) {
